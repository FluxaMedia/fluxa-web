---
title: "Fluxa Dokümanlar"
description: "Fluxa dokümantasyonu: başlangıç, sık yapılan işler, sorun giderme, ayarlar, addon'lar, oynatma, eşitleme ve hesap rehberleri."
tagline: "Kurulum, addon'lar, oynatma, eşitleme, kütüphane akışları, ayarlar ve sorun giderme için buradan başla."
shotTitle: "Fluxa Ana Ekran"
buttons:
  - { label: "Kuruluma başla", href: "/docs/getting-started", primary: true }
  - { label: "Sorun gider", href: "/docs/troubleshooting" }
  - { label: "Terimleri öğren", href: "/docs/concepts" }
---
...
:::info
**Fluxa içerik sağlamaz.** Uygulama, senin kurduğun addon'lara bağlanır. Ana ekran boşsa veya hiçbir şey oynatılmıyorsa addon rehberi ve sorun giderme sayfasıyla başla.
:::

:::note
**Başka bir şey mi arıyorsun?** Mimari, gelişmiş oynatma, debrid/Usenet kurulumu, ayar başvurusu, platform notları ve gerisi soldaki menüde konuya göre gruplanmış durumda. İsimle aramak için `/` tuşuna bas.
:::
